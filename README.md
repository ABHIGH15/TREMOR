...
**Blast Radius** is a live, browser-based "system context cockpit" that lets an AI coding agent and a human engineer see the *same* real-time picture of a codebase's dependency graph, change history, and past regressions — via **WebMCP tools** — before a risky AI-generated change ships.
...
Blast Radius registers structured browser tools directly to the agent's context:

```typescript
// WebMCP Tool Registration in BLAST RADIUS
